  ...
  translations: {
    ...
    modal: {
      ...
      newConversation: {
        ...
        newConversationDescription: 'Átkutatom a dokumentációdat, és gyorsan segítek a beállítási útmutatókkal, funkcióleírásokkal és hibaelhárítási tippekkel.'
      },
      footer: {
...
} satisfies { translations: AlgoliaSearchTranslations }
